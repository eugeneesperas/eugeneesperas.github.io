...
const Sun = () => {
  const sunBeachDestinations = [
    ...
    },
    {
      ...
      description:
        "El Nido is a tropical paradise known for its limestone cliffs, hidden lagoons, and breathtaking island hopping tours.",
    },
    {
      name: "Panglao Island",
      image: "/images/b4.jpg",
      description:
        "Panglao Island offers beautiful beaches, world-class diving spots, and the opportunity to swim with majestic whale sharks.",
    },
    {
      name: "Coron",
      image: "/images/l7.jpg",
    ...
    },
    {
      ...
      description:
        'Camiguin is known as the "Island Born of Fire" with its volcanic beaches, hot springs, and picturesque waterfalls.',
    },
    {
      name: "Caramoan",
      image: "/images/b8.jpg",
    ...
    },
    {
      ...
      image: "/images/b3.jpg",
      description:
        "Pagudpud is the northernmost tip of Luzon, offering long stretches of white sand beaches, clear waters, and scenic landscapes.",
    },
    {
      name: "Siquijor",
      image: "/images/m9.jpg",
    ...
    },
    {
      ...
      image: "/images/m2.jpg",
      description:
        "Zambales is a coastal province with stunning beaches, surf spots, and the picturesque coves of Anawangin and Nagsasa.",
    },
  ];
