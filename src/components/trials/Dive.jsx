...
const Dive = () => {
  const divingDestinations = [
    ...
    },
    {
      ...
      description:
        "Puerto Galera is a popular diving destination known for its vibrant marine life and numerous dive sites.",
    },
    {
      name: "Coron",
      image: "/six/coron.jpg",
    ...
    },
    {
      ...
      description:
        "Balicasag Island offers stunning wall dives and the chance to encounter sea turtles and schools of jacks.",
    },
    {
      name: "Monad Shoal",
